...
<template>
    <div class="w-full h-20 grid grid-cols-4 gap-1 text-xs">
        <NuxtLink to="/questions" :class="{ 'bg-slate-700': $route.path === '/questions' }"
        ...
        <NuxtLink to="/discover" :class="{ 'bg-slate-700': $route.path === '/discover' }"
            class="p-[7px] w-auto m-0 flex flex-col items-center hover:text-black hover:bg-white rounded-lg">
            <Icon :name="getIcon('/discover').icon" size="2rem" class="mt-2" />
            Discover
        </NuxtLink>
        <NuxtLink to="/contacts" :class="{ 'bg-slate-700': $route.path === '/contacts' }"
            class="p-[7px] w-auto m-0 flex flex-col items-center hover:text-black hover:bg-white rounded-lg">
            <Icon :name="getIcon('/contacts').icon" size="2rem" class="mt-2" />
            My&nbsp;contacts
        </NuxtLink>
        <NuxtLink to="/my-profile" :class="{ 'bg-slate-700': $route.path === '/my-profile' }"
            class="p-[7px] w-auto m-0 flex flex-col items-center hover:text-black hover:bg-white rounded-lg">
