...
<div class="odd:dark:bg-slate-700 even:dark:bg-slate-700/50 odd:bg-slate-100 even:bg-slate-200/50 dark:border-none w-full border  p-2 md:p-3 lg:p-5">
  ...
  <div class="w-full flex flex-row justify-center items-center dark:text-slate-700 pt-3 gap-2 md:gap-4">
      <button on:click={() => submitAnswer(true)} disabled={skipPending || answerPending} class="bg-green-400 hover:bg-green-500 h-16 w-4/12 rounded-xl flex justify-center items-center grow">
        <h3>
      ...
      <button on:click={skipQuestion} disabled={skipPending || answerPending} class="dark:bg-slate-600 h-16 w-16 md:w-36 rounded-xl dark:hover:bg-slate-800/70 bg-slate-200 hover:bg-slate-300 flex justify-center items-center">
      ...
      <button on:click={() => submitAnswer(false)} disabled={skipPending || answerPending} class="bg-red-400 hover:bg-red-500 h-16 w-4/12 rounded-xl flex justify-center items-center grow">
        <h3>
